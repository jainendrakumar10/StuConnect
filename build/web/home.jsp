...
<div id="page_wrapper">
  <div id="header_wrapper">
    ...
    <div id="navcontainer">
      <ul id="navlist">
        <li id="active"><a href="home.jsp" id="current">Home</a></li>
...
It is a thriving free student discussion forum, if you can think of a topic there will be somewhere for you to discuss it here.</p>
        ...
        <p>First of all, registration is completely free. Registration is quick and simple, and only by registering can you get the complete forum experience. Registering enables you to: 
...
A 'post' is the name given to each individual comment made in threads by StuConnect members.<br>
...
<b>What's a sub?</b> <br>
A 'sub' can either refer to a 'subscriber', a member who pays to subscribe to the website in order to access other forums and features not available to ordinary members, or a subscription?, which is the name of paid package that subscribers have purchased.</p>
        <br><br>
          <%
    Integer hitsCount = 
