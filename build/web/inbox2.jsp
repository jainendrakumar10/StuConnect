    ...
    <div id="content">
        <h3>Message Received</h3>
         <% 
            ...
            out.println("<tr>");
            out.println("<th bgcolor=#4169E1><font color=#FFFFFF>Message</font></th>");
          
             PreparedStatement ps=con.prepareStatement("select message from inbox where mid=?");
             ps.setInt(1,Integer.valueOf(mid2));   
